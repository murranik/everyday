...
class _AlarmScreenState extends State<AlarmScreen> with WidgetsBindingObserver  {
  ...
  void initState() {
    ...
    WidgetsBinding.instance!.addPostFrameCallback((_) => getNotificationAccessDialog());
    super.initState();
  }
              ...
              title: Column(
                children: [
                  Row(
                    children: const [
                      Expanded(
                          child: Text("Для використання будильника дозвольте відправку сповіщень")
                      )
                    ],
                  )
                ],
                      ...
                      Row(
                        ...
                        children: [
                          GestureDetector(
                            ...
                            child: Container(
                                width: orientation == Orientation.portrait  ? 98.5.w : 98.5.h,
                                      ...
                                      child: Column(
                                        children: [
                                          Row(
                                            children: [
                                              Padding(
                                                padding: EdgeInsets.only(left: 8.sp, bottom: 2.sp),
                                                child: Text(
                                                  element.label,
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              Padding(
                                                padding: EdgeInsets.only(left: 8.sp, bottom: 2.sp),
                                                child: Text(
                                                  intl.DateFormat.Hm().format(DateTime.parse(element.dateTime!)),
                                                  style: TextStyle(fontSize: 18.sp),
                                                ),
                                              ),
                                            ],
                                            ...
                                            Container(
                                              ...
                                              child: ListView.builder(
                                                ...
                                                itemBuilder: (context, index) {
                                                  List<String> m = [];
                                                  if(element.rangeOfDateForRepeat != null) {
                                                    m = element.rangeOfDateForRepeat!.split('/');
                                                    m.removeLast();
                                                  }
                                                  if(m.isNotEmpty) {
                                                    return Container(
                                                      ...
                                                      child: Text(
                                                        ...
                                                        style: TextStyle(
                                                            fontSize: 13.sp,
                                                            color: m.any((element) => element == weekDays[index]) ? const Color(0xff2a9863) : Colors.black,
                                                        ),
                                                      ),
                                                    );
                                                  } else {
                                                    return Text(
                                                      intl.DateFormat.MMMd('uk').format(DateTime.parse(element.dateTime!)).replaceAll('.', ''),
                                                      style: TextStyle(
                                                          fontSize: 13.sp,
                                                          color: Colors.black
                                                      ),
                                                ...
                                                itemCount: element.rangeOfDateForRepeat == "" ? 1 : element.rangeOfDateForRepeat!.split('/').isNotEmpty ? 7 : 1,
                                              ),
                                            ),
                                            Checkbox(
                                                value: element.isActive == 1 ? true : false,
                                                activeColor: const Color(0xff2a9863),
                                                onChanged: (value) {
                                                  final intValue = value == true ? 1 : 0;
