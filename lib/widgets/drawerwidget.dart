...
class _DrawerWidgetState extends State<DrawerWidget> {
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            iconButtonWithText("Будильник", "assets/images/alarm.png", "Alarm"),
            SizedBox(
              height: 2.h,
            ),
            iconButtonWithText("Органайзер", "assets/images/note.png", "Organizer"),
            SizedBox(
              height: 2.h,
            ),
            iconButtonWithText("Календар", "assets/images/calendar.png", "Calendar"),
            SizedBox(
              height: 2.h,
            ),
  ...
  Widget iconButtonWithText(String text, String icon, String pageName){
    ...
    return GestureDetector(
      ...
      child: Row(
        children: [
          SizedBox(width: orientation == Orientation.portrait  ? 1.5.w : 1.5.h,),
